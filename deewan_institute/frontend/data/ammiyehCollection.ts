...
export const ammiyehCollection: CollectionBook[] = [
  ...
  },
  {
    ...
    author: "Mohammad K. Ayaseh",
    description:
      "This practice book is a companion to The Comprehensive Guide to Levantine Arabic, designed to help students deepen their understanding and actively apply their knowledge of Levantine Arabic.",
    reviews: [
      {
        reviewer: "	dave",
        rating: 5,
      ...
      },
      {
        ...
        rating: 5,
        comment:
          "After much research, we purchased this book--and both my husband and daughter are studying it 30 minutes a day. It's excellent from what they are saying. Highly recommended.",
      },
      {
        reviewer: "Diana Patricia González Estrada",
        rating: 5,
        comment:
          "I am student at Deewan, and the book is very well done for learning Arabic language. It has good examples to study by yourself too.",
      },
    ],
    viewMoreLink: "#",
    price: 15,
    samplePdf: "/assets/pdf/samples/practice-sample.pdf",
    frontCover: "/assets/images/books/ammiyeh/practice-front.jpg",
    backCover: "/assets/images/books/ammiyeh/practice-back.jpg",
  },
  {
    ...
    viewMoreLink: "#",
    price: 20,
    samplePdf: "/assets/pdf/samples/book-2-sample.pdf",
    frontCover: "/assets/images/books/ammiyeh/book-2-front.jpg",
    backCover: "/assets/images/books/ammiyeh/book-2-back.jpg",
  },
  // {
  //     id: "ammiyeh-advanced",
    ...
    reviews: [
      {
        ...
        rating: 5,
        comment:
          "Recientemente tuve el placer de leer - LA GUÍA COMPLETA DE ÁRABE LEVANTINO, y debo decir que superó todas mis expectativas. Este libro es verdaderamente una joya para cualquier persona interesada en aprender árabe levantino.",
      },

      {
        ...
        rating: 5,
        comment:
          "Estuve buscando un buen manual para introducirme en el arabe a traves del dialecto levantino/shaami",
      },
    ],
    viewMoreLink: "#",
    price: 20,
    samplePdf: "/assets/pdf/samples/sp-sample.pdf",
    frontCover: "/assets/images/books/ammiyeh/sp-front.jpg",
    backCover: "/assets/images/books/ammiyeh/sp-back.jpg",
  },
];

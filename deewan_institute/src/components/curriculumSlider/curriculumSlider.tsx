                        ...
                        <div className="container-fluid d-flex align-items-center justify-content-center mt-5">
                            <div className="row w-100 h-auto">
                                <div className="col-md-6 text-center d-flex flex-column align-items-center gap-2">
                                    <img src={"../assets/images/books/msa.png"} alt="MSA Book" width="450" height="550" className="img-fluid" />
                                ...
                                <div className="col-md-6 text-center d-flex flex-column align-items-center gap-2">
                                    <img src={"../assets/images/books/ammiyeh.png"} alt="Levantine Book" width="450" height="550" className="img-fluid" />
                                    <div className="my-4 px-2">
                                ...
                                <div className="col-md-6 text-center d-flex flex-column align-items-center justify-content-center gap-2">
                                    <div className="row h-auto justify-content-between g-3">
                                        <div className="col-md-6">
                                            <img src={"../assets/images/books/PBSeason1.png"} alt="Podcast S1" className="img-fluid" />
                                        </div>
                                        <div className="col-md-6">
                                            <img src={"/assets/images/books/PBSeason2.png"} alt="Podcast S2" className="img-fluid" />
                                        </div>
                                        <div className="col-md-6">
                                            <img src={"../assets/images/books/PBSeason3.png"} alt="Podcast S3" className="img-fluid" />
                                        </div>
                                        <div className="col-md-6">
                                            <img src={"../assets/images/books/PBSeason5.png"} alt="Podcast S5" className="img-fluid" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="container-fluid d-flex align-items-center justify-content-center mt-5">
                            <div className="row w-100 h-auto justify-content-center">
                                <div className="col-md-6 text-center d-flex flex-column align-items-end justify-content-center gap-2">
                                    <img src={"../assets/images/books/idioms.png"} alt="Idioms Book" className="img-fluid" />
                                </div>
                                <div className="col-md-6 text-center d-flex flex-column align-items-center justify-content-center gap-2">
